...
export class Backend implements backendInterface {
    ...
    async listAllPhotos(): Promise<Array<PhotoMetadata>> {
        if (this.processError) {
            try {
    ...
    async uploadPhoto(arg0: string, arg1: string | null, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(arg0, to_candid_opt_n18(this._uploadFile, this._downloadFile, arg1), await to_candid_ExternalBlob_n19(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PhotoMetadata_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoMetadata): Promise<PhotoMetadata> {
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoMetadata>): Promise<Array<PhotoMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoMetadata_n14(_uploadFile, _downloadFile, x)));
}
